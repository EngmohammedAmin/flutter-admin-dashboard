...
import 'package:admin_dashboard/features/dashboard/dummy_inventories.dart';
import 'package:admin_dashboard/features/dashboard/inventory.dart';
      ...
      child: TableView.builder(
        ...
        columnBuilder: (index) {
          return TableSpan(
            ...
            // يقوم بضبط العرض عن طريق تقسيم منفذ العرض إلى 8 أجزاء.
        ...
        cellBuilder: (context, vicinity) {
          ...
          return TableViewCell(
            child: ColoredBox(
              color:
                  isStickyHeader ? Colors.blue[500]! : colorScheme.background,
              child: Center(
                child: FittedBox(
                  child: Padding(
